...
export default function MedicoScreen({ navigation }) {
  const opciones = [
    { label: "Mis Citas", screen: "ListarCitasMedico" },
    { label: "Historial de Pacientes", screen: "ListarHistorialMedico" },
    { label: "Especialidades Asignadas", screen: "ListarEspecialidadesMedico" },
  ];
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Panel del Médico</Text>
